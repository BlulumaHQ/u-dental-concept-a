...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    short: "Treatment with enhanced precision and clarity using a dental microscope.",
    category: "advanced",
    image: "/services/microscopic-dentistry.png",
    intro: "Microscopic dentistry uses a high-magnification dental microscope to perform restorative, endodontic, and cosmetic treatments with exceptional accuracy and clarity.",
    benefits: ["Enhanced visual precision", "More conservative tooth preparation", "Improved treatment predictability"],
    when: ["Detailed restorative work", "Root canal therapy", "Cosmetic refinements"],
    tech: "Performed under Leica M320D dental microscope.",
  },
  {
    slug: "bioclear",
    name: "Bioclear",
    short: "Advanced composite technique using clear matrices for natural-looking restorations.",
    category: "cosmetic",
    image: "/services/bioclear.png",
    intro: "Bioclear is a modern injection-molded composite technique that uses clear matrices and warmed flowable composite to close black triangles and rebuild teeth with strength and beauty.",
    benefits: ["Closes black triangles", "Minimally invasive", "Natural-looking, durable result"],
    when: ["Black triangles between teeth", "Worn or chipped teeth", "Cosmetic improvement without veneers"],
  },
  {
    slug: "galvosurge-for-peri-implantitis-treatment",
    name: "GalvoSurge for Peri-Implantitis Treatment",
    short: "Advanced cleaning system to support implants affected by peri-implantitis.",
    category: "advanced",
    image: "/services/galvosurge.png",
    intro: "GalvoSurge is an advanced electrolytic cleaning system designed to remove biofilm from the surface of compromised dental implants, supporting implant health and longevity.",
    benefits: ["Targeted biofilm removal", "Supports implant longevity", "Minimally invasive workflow"],
    when: ["Peri-implantitis", "Inflamed tissue around an implant", "Long-term implant maintenance"],
  },
  {
    slug: "botox",
    name: "Botox",
